...
import companyScanRouter from "./routes/companyScan";
...
import companyPosApiRouter from "./routes/companyPosApi";
...
app.use("/company/:slug/scan", companyScanRouter);
...
app.use("/company/:slug/pos-api", companyPosApiRouter);
